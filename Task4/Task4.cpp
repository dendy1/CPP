...
// Task4.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTask4App, CWinApp)
...
// Единственный объект CTask4App

CTask4App theApp;


// Инициализация CTask4App

BOOL CTask4App::InitInstance()
{
